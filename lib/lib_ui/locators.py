...
class MainPageLocators:
    ...
    SINGLE_USER_NOT_FOUND_BUTTON_LOCATOR = (By.CSS_SELECTOR, "[data-id='users-single-not-found']")
    ...
    SINGLE_RESOURCE_NOT_FOUND_BUTTON_LOCATOR = (By.CSS_SELECTOR, "[data-id='unknown-single-not-found']")
    ...
    REGISTER_SUCCESSFUL_BUTTON_LOCATOR = (By.CSS_SELECTOR, "[data-id='register-successful']")
    REGISTER_UNSUCCESSFUL_BUTTON_LOCATOR = (By.CSS_SELECTOR, "[data-id='register-unsuccessful']")
    LOGIN_SUCCESSFUL_BUTTON_LOCATOR = (By.CSS_SELECTOR, "[data-id='login-successful']")
    LOGIN_UNSUCCESSFUL_BUTTON_LOCATOR = (By.CSS_SELECTOR, "[data-id='login-unsuccessful']")
